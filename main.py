...
def router_node(state: GraphState) -> str:
    ...
    The **vectorstore** contains documents about **Food menu explainer**. The **web_search** tool can access real-time information about latest food allergic information from foodallergy.org. 
...
def web_search_node(state: GraphState) -> GraphState:
    ...
    tavily_search = TavilySearch(
        ...
        include_domains=["foodallergy.org"]
    )
...
def main():
    ...
    st.markdown("Ask questions about food allergies or any health-related topics!")
    ...
    # Chat input
    if question := st.chat_input("Ask a question about food menu or food allergy topics..."):
